...
import 'contact_object_validator.dart';
import 'license_object_validator.dart';

/// Validator for Info Objects according to OpenAPI 3.0.0 specification.
class InfoObjectValidator {
  ...
  static void _validateContactField(Map<dynamic, dynamic> data, String path) {
    if (data.containsKey('contact')) {
      ...
      ContactObjectValidator.validate(contact, ValidationUtils.buildPath(path, 'contact'));
    }
  }
  ...
  static void _validateLicenseField(Map<dynamic, dynamic> data, String path) {
    if (data.containsKey('license')) {
      ...
      LicenseObjectValidator.validate(license, ValidationUtils.buildPath(path, 'license'));
    }
  }
