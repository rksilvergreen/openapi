...
import 'server_variable_object_validator.dart';

/// Validator for Server Objects according to OpenAPI 3.0.0 specification.
class ServerObjectValidator {
  ...
  static void _validateVariable(dynamic variable, String keyStr, String path) {
    ...
    ServerVariableObjectValidator.validate(
      variable,
      ValidationUtils.buildPath(path, 'variables.$keyStr'),
    );
  }
