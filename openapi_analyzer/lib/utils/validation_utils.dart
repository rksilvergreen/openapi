...
String buildPath(String current, String next) {
  if (current.isEmpty) {
    return next;
  }
  return '$current/$next';
...
T requireField<T>(Map<dynamic, dynamic> data, String field, String path) {
...
void validateType(dynamic value, Type expected, String path) {
...
void validatePattern(String value, String pattern, String path) {
...
void validateEnum(String value, List<String> allowed, String path) {
...
void validateNonNegative(num value, String path) {
  if (value < 0) {
    throw OpenApiValidationException(
      path,
...
void validatePositive(num value, String path) {
  if (value <= 0) {
    throw OpenApiValidationException(
      path,
...
Map<dynamic, dynamic> requireMap(dynamic value, String path) {
  if (value is! Map) {
    throw OpenApiValidationException(
      path,
...
List<dynamic> requireList(dynamic value, String path) {
  if (value is! List) {
    throw OpenApiValidationException(
      path,
...
String requireString(dynamic value, String path) {
  if (value is! String) {
    throw OpenApiValidationException(
      path,
...
bool requireBool(dynamic value, String path) {
  if (value is! bool) {
    throw OpenApiValidationException(
      path,
...
num requireNumber(dynamic value, String path) {
  if (value is! num) {
    throw OpenApiValidationException(
      path,
...
void validateNoUnknownFields(Map<dynamic, dynamic> data, Set<String> allowedFields, String path, String objectType) {
